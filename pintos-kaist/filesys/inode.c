...
void inode_close(struct inode *inode)
{
	...
	/* 이제 마지막 참조. removed 플래그 검사하고
	   리스트에서 제거, 블록 해제는 락 밖에서 해줘도 되지만
	   removed 플래그는 이미 락 안에서 안전하게 읽었으므로 OK */
	bool do_remove = inode->removed;
